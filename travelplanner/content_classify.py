...
CLASSIFY_PROMPT = (
  ...
  "as a place to go, use travel, not food. A broad city, state, or country "
  "location tag (e.g. 'Brooklyn, NY' or 'Rome, Italy') tagged for algorithm "
  "reach does NOT make home cooking travel.\n"
