...
| 8 | **Visit / want-to-go status** | Want to go · Been · Skip on places; filter the library by status (builds on existing `Visit`) | In progress — Been one-tap + optional dates; Want/Skip + filters TBD |
